...
echo @$msg;                       
echo "<table>";
	echo form_open('admin/violation');
	...
	//	echo "<td>".form_input('yrlvl','','class="form-control" placeholder="Year Level" required')."</td>";
	//echo "</tr>";
	...
	echo "<tr>";
		...
		$arrayName = array('1'	 => 	'First Year',
						   ...
						   '4'	 =>		'Fourth Year',
						   '5'	 =>		'Fifth Year');
		echo "<td>".form_dropdown('yrlvl',$arrayName,'class="form-control" placeholder="Department"')."</td>";
	echo "</tr>";


	//echo "<tr>";
	//	echo "<td>Course</td>";
	//	echo "<td>".form_input('course','','class="form-control" placeholder="Course" required')."</td>";
	//echo "</tr>";
	...
	echo "<tr>";
		...
		echo "<td>".form_input('violtn','','class="form-control" placeholder="Violation" required')."</td>";
	echo "</tr>";
